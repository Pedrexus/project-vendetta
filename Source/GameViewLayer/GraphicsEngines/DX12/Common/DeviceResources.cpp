...
#pragma region shader support check
	{
#if defined(NTDDI_WIN10_VB) && (NTDDI_VERSION >= NTDDI_WIN10_VB)
		m_shaderModel.HighestShaderModel = D3D_SHADER_MODEL_6_6;
		...
		m_shaderModel.HighestShaderModel = D3D_SHADER_MODEL_6_4;
#elif defined(NTDDI_WIN10_RS4) && (NTDDI_VERSION >= NTDDI_WIN10_RS4)
		m_shaderModel.HighestShaderModel = D3D_SHADER_MODEL_6_2;
#elif defined(NTDDI_WIN10_RS3) && (NTDDI_VERSION >= NTDDI_WIN10_RS3)
		m_shaderModel.HighestShaderModel = D3D_SHADER_MODEL_6_1;
#else
		m_shaderModel.HighestShaderModel = D3D_SHADER_MODEL_6_0;
#endif

		hr = m_d3dDevice->CheckFeatureSupport(D3D12_FEATURE_SHADER_MODEL, &m_shaderModel, sizeof(m_shaderModel));
		while (hr == E_INVALIDARG && m_shaderModel.HighestShaderModel > D3D_SHADER_MODEL_6_0)
		{
			m_shaderModel.HighestShaderModel = static_cast<D3D_SHADER_MODEL>(static_cast<int>(m_shaderModel.HighestShaderModel) - 1);
			hr = m_d3dDevice->CheckFeatureSupport(D3D12_FEATURE_SHADER_MODEL, &m_shaderModel, sizeof(m_shaderModel));
		}

		if (FAILED(hr))
		{
			m_shaderModel.HighestShaderModel = D3D_SHADER_MODEL_5_1;
		}
	}
#pragma endregion
}
...
void DX::DeviceResources::Clear(XMVECTORF32 backgroundColor)
{
