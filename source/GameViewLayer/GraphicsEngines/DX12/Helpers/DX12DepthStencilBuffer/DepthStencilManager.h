...
protected:
	inline D3D12_RESOURCE_DESC Specify(u32 width, u32 height, DXGI_SAMPLE_DESC msaa)
	{
	...
	void CreateResource(const u32& width, const u32& height, const DXGI_SAMPLE_DESC& msaa, ID3D12Device* device);
...
public:
	...
	void Resize(ID3D12Device* device, u32 width, u32 height, DXGI_SAMPLE_DESC msaa);
